...
resource "aws_s3_bucket_policy" "tpgdapne2_vpcflow_log_bucket_policy" {
  bucket = aws_s3_bucket.tpgdapne2_vpcflow_log.id
  policy = data.aws_iam_policy_document.tpgdapne2_vpcflow_log_bucket_policy_document.json
}

data "aws_iam_policy_document" "tpgdapne2_vpcflow_log_bucket_policy_document" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::tpgdapne2-vpcflow-log/AWSLogs/${var.account_id.id}/*",
    ]
  }
  statement {
    ...
    resources = [
      "arn:aws:s3:::tpgdapne2-vpcflow-log",
    ]
  }
}